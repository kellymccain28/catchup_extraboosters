...
makeplots <- function(){
  ...
  pp <- plot_cohortsage(var = 'cases_averted_perpop',
                        strat = 'catch-up',
                        seas = 'seasonal')
  ggsave("plots/cohorts_CU_CAperpop_AMMnetMIM_seas.png", pp, width = 10, height = 6)
  # ppp <- plot_cohortsage(var = 'cases_averted_perdose',
  #                        strat = 'catch-up',
  #                        seas = 'seasonal')
  # ggsave("plots/cohorts_CU_CAperdose_AMMnetMIM_seas.png", ppp, width = 10, height = 6)
  pppp <- plot_cohortsage(var = 'cases_per1000pop',
                         strat = 'catch-up',
                         seas = 'seasonal')
  ggsave("plots/cohorts_CU_casesperpop_AMMnetMIM_seas.png", pppp, width = 10, height = 6)
  
  pp <- plot_cohortsage(var = 'cases_averted_perpop',
                        strat = 'AB',
                        seas = 'seasonal')
  ggsave("plots/cohorts_AB_CAperpop_AMMnetMIM_seas.png", pp, width = 10, height = 6)
  # ppp <- plot_cohortsage(var = 'cases_averted_perdose',
  #                        strat = 'AB',
  #                        seas = 'seasonal')
  # ggsave("plots/cohorts_AB_CAperdose_AMMnetMIM_seas.png", ppp, width = 10, height = 6)
  pppp <- plot_cohortsage(var = 'cases_per1000pop',
                          strat = 'AB',
                          seas = 'seasonal')
  ggsave("plots/cohorts_AB_casesperpop_AMMnetMIM_seas.png", pppp, width = 10, height = 6)
  
  #perennial
  pp <- plot_cohortsage(var = 'cases_averted_perpop',
                        strat = 'catch-up',
                        seas = 'perennial')
  ggsave("plots/cohorts_CU_CAperpop_AMMnetMIM_per.png", pp, width = 10, height = 6)
  # ppp <- plot_cohortsage(var = 'cases_averted_perdose',
  #                        strat = 'catch-up',
  #                        seas = 'perennial')
  # ggsave("plots/cohorts_CU_CAperdose_AMMnetMIM_per.png", ppp, width = 10, height = 6)
  pppp <- plot_cohortsage(var = 'cases_per1000pop',
                          strat = 'catch-up',
                          seas = 'perennial')
  ggsave("plots/cohorts_CU_casesperpop_AMMnetMIM_per.png", pppp, width = 10, height = 6)
  
  pp <- plot_cohortsage(var = 'cases_averted_perpop',
                        strat = 'AB',
                        seas = 'perennial')
  ggsave("plots/cohorts_AB_CAperpop_AMMnetMIM_per.png", pp, width = 10, height = 6)
  # ppp <- plot_cohortsage(var = 'cases_averted_perdose',
  #                        strat = 'AB',
  #                        seas = 'perennial')
  # ggsave("plots/cohorts_AB_CAperdose_AMMnetMIM_per.png", ppp, width = 10, height = 6)
  pppp <- plot_cohortsage(var = 'cases_per1000pop',
                          strat = 'AB',
                          seas = 'perennial')
  ggsave("plots/cohorts_AB_casesperpop_AMMnetMIM_per.png", pppp, width = 10, height = 6)
  ...
  p <- plot_cohortsageatvax(var = 'cases_averted_perpop',
                            strat = 'catch-up',
                            seas = 'perennial')
  ggsave("plots/plot_cohorts_ageatvax_CAperpop_per.png", p, height = 6, width = 9)
  ...
  ggsave("plots/plot_cohorts_ageatvax_CAperpoptotals_per.png", ppp, height = 6, width = 12)
  
  
  p2 <- plot_cohortsageatvax(var = 'cases_averted',
                             strat = 'catch-up',
                             seas = 'perennial')
  ggsave("plots/plot_cohorts_ageatvax_CA_per.png", p2, height = 6, width = 9)
  
  p3 <- plot_cohortsageatvax(var = 'cases_per1000pop',
                       strat = 'catch-up',
                       seas = 'perennial')
  ggsave("plots/plot_cohorts_ageatvax_cases_per.png", p3, height = 6, width = 9)
  
  p4 <- plot_cohortsageatvax(var = 'sevcases_per1000pop',
                       strat = 'catch-up',
                       seas = 'perennial')
  ggsave("plots/plot_cohorts_ageatvax_sevcases_per.png", p4, height = 6, width = 9)
  ...
  p <- plot_cohortsageatvax(var = 'cases_averted_perpop',
                            strat = 'catch-up',
                            seas = 'seasonal')
  ggsave("plots/plot_cohorts_ageatvax_CAperpop_seas.png", p, height = 6, width = 9)
  
  totals_seas <- plot_overall_CA_cohort(seas = 'seasonal')
  # put cases averted per 1000 by age and age at vax next to totals plot 
  ppp <- cowplot::plot_grid(p, totals_seas, rel_widths = c(1, 0.75), labels = 'AUTO')
  ggsave("plots/plot_cohorts_ageatvax_CAperpoptotals_seas.png", ppp, height = 6, width = 12)
  ...
  p2 <- plot_cohortsageatvax(var = 'cases_averted',
                             strat = 'catch-up',
                             seas = 'seasonal')
  ggsave("plots/plot_cohorts_ageatvax_CA_seas.png", p2, height = 6, width = 9)
  
  p3 <- plot_cohortsageatvax(var = 'cases_per1000pop',
                             strat = 'catch-up',
                             seas = 'seasonal')
  ggsave("plots/plot_cohorts_ageatvax_cases_seas.png", p3, height = 6, width = 9)
  
  p4 <- plot_cohortsageatvax(var = 'sevcases_per1000pop',
                             strat = 'catch-up',
                             seas = 'seasonal')
  ggsave("plots/plot_cohorts_ageatvax_sevcases_seas.png", p4, height = 6, width = 9)
} 
